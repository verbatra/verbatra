...
`doctor` se incorporó en 0.9.0. `pseudo` y `extract` son las incorporaciones más recientes a esa lista.
...
Las recetas de esta página son la referencia. Si prefieres darle a un agente el conocimiento operativo por adelantado, el repositorio de verbatra incluye tres documentos de skill que hacen justo eso, instalables con la CLI de [skills.sh](https://www.skills.sh/docs):
