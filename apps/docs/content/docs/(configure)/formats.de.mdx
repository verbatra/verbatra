...
Sie gilt für jedes Format, aber pro Wert statt pro Format, und sie tritt bei einem Wert zurück,
dessen eigener Adapter sein Markup bereits als Platzhalter meldet:
...
- `next-intl-json` und `arb` parsen ICU-Rich-Text-Tags, ein gepaartes `<b>...</b>` ist für sie also
  bereits ein Platzhalter. Ein Tag mit Attributen ist überhaupt kein gültiges ICU, und diese
  Formate lehnen es unabhängig von der Markup-Parität als ungültige Message-Syntax ab.
