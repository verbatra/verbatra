...
translation. In Studio, a retranslate or an edit comes back as `Rejected: inline markup mismatch`,
...
it. If the source value is the one with the broken markup, fix it there: the check stands down when
