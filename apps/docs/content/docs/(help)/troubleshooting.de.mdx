...
Eine Ablehnung mit `+more than 256 inline tags` bedeutet, dass der Kandidat mehr Tags trägt, als die
Prüfung liest, seine Quelle aber nicht. Drei weitere Fälle sind gewollte Ablehnungen und keine
Fehler: zwei benachbarte Paare zu einem verschmelzen, die Groß- und Kleinschreibung eines Tags
ändern und einen Attributnamen ergänzen oder entfernen, einschließlich eines `dir`-Attributs für ein
rechtsläufiges Ziel. Lass die Tags so, wie die Quelle sie hat, und bring die Änderung dort unter, wo
die Prüfung nicht hinsieht, etwa in einem Attributwert. Liegt das kaputte Markup im Quellwert,
korrigiere es dort: Die Prüfung tritt zurück, wenn die Tags der Quelle fehlerhaft sind, eine kaputte
Quelle schaltet sie für diesen Key also stillschweigend ab.
