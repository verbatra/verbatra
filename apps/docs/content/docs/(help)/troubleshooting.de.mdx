...
das bereitgestellte Tool-Set des MCP-Servers darf sich nicht pro Verbindung ändern, also werden die
beiden kostenpflichtigen Tools ganz weggelassen, statt bereitgestellt und dann abgelehnt zu werden,
wenn Ausgaben nicht erlaubt sind.
