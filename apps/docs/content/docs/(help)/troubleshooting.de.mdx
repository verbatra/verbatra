...
`Rejected: inline markup mismatch` zurück.
...
wohlgeformten Tags wird also angenommen. Wortreihenfolge und Attributwerte sind nie die Ursache,
denn beides wird nicht verglichen. Liegt das kaputte Markup im Quellwert, korrigiere es dort: Die
Prüfung tritt zurück, wenn das Markup der Quelle nicht wohlgeformt ist, eine kaputte Quelle
schaltet sie für diesen Key also stillschweigend ab.
