...
Die Zahl ist aus denselben zwei Gründen eine Obergrenze wie die Dry-Run-Zahl, und aus einem dritten: Tokens werden aus Zeichenzahlen abgeleitet, nicht aus dem Tokenizer des Providers. Die Zeile `estimate excludes` benennt bei jedem Lauf alle drei.
