...
La cifra es un límite superior por las mismas dos razones que el recuento de la ejecución en seco, y por una tercera: los tokens se derivan de recuentos de caracteres, no del tokenizador del proveedor. La línea `estimate excludes` nombra las tres en cada ejecución.
