...
description: "Dimensiona una ejecución de traducción antes de gastar: cuenta las claves con un dry run, conviértelas en peticiones y tokens, y ponles precio con las tarifas de tu proveedor."
---
