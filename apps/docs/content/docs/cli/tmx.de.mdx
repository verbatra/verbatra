...
| `--dry-run` | keins | aus | beim Import prüfen und melden, ohne den Memory zu verändern |
| `--overwrite` | keins | aus | beim Import eine importierte Einheit eine Übersetzung ersetzen lassen, die der Memory schon hat |
